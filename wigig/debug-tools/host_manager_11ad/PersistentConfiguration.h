...
public:
    ...
    ConfigurationParameter<std::string> Ignore3ppFwEventIds;
...
class PostLogCollectionSection final : public ConfigurationSection
{
public:
    explicit PostLogCollectionSection(JsonTree& configTreeRoot);
    ConfigurationParameter<std::string> TargetServer;
    ConfigurationParameter<std::string> UserName;
    ConfigurationParameter<std::string> RemotePath;
...
public:
    ...
    PostLogCollectionSection PostLogCollection;
