...
#define LOG_IMS_RTP_MEDIA_METRICS_INFO_C                      ((0xCD0) + LOG_1X_BASE_C)
#define LOG_ROHC_COMPRESSOR_BUFFER_SIZE_FAILURE_C             ((0xCD1) + LOG_1X_BASE_C)
#define LOG_ROHC_DECOMPRESSOR_BUFFER_SIZE_FAILURE_C           ((0xCD2) + LOG_1X_BASE_C)
#define LOG_DIAG_HEALTH_REPORT_C                              ((0xCD3) + LOG_1X_BASE_C)
...
#define LOG_1X_LAST_C                                         ((0xCDD) + LOG_1X_BASE_C)
