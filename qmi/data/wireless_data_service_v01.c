...
/* This file was generated with Tool version 6.14.7
   It was generated on: Fri Mar  6 2020 (Spin 0)
...
static const uint8_t wds_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wds_indication_register_req_msg_v01, report_lte_attach_failure_info) - QMI_IDL_OFFSET16RELATIVE(wds_indication_register_req_msg_v01, report_lte_attach_failure_info_valid)),
  0x33,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wds_indication_register_req_msg_v01, report_lte_attach_failure_info),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wds_indication_register_req_msg_v01, report_data_prioritization_info) - QMI_IDL_OFFSET16RELATIVE(wds_indication_register_req_msg_v01, report_data_prioritization_info_valid)),
  0x34,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wds_indication_register_req_msg_v01, report_data_prioritization_info)
};
...
static const uint8_t wds_data_prioritization_info_ind_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wds_data_prioritization_info_ind_v01, mux_id) - QMI_IDL_OFFSET8(wds_data_prioritization_info_ind_v01, mux_id_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wds_data_prioritization_info_ind_v01, mux_id),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wds_data_prioritization_info_ind_v01, ul_data_prio_state) - QMI_IDL_OFFSET8(wds_data_prioritization_info_ind_v01, ul_data_prio_state_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wds_data_prioritization_info_ind_v01, ul_data_prio_state),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wds_data_prioritization_info_ind_v01, ul_ipv4_dscp) - QMI_IDL_OFFSET8(wds_data_prioritization_info_ind_v01, ul_ipv4_dscp_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wds_data_prioritization_info_ind_v01, ul_ipv4_dscp),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wds_data_prioritization_info_ind_v01, ul_ipv6_dscp) - QMI_IDL_OFFSET8(wds_data_prioritization_info_ind_v01, ul_ipv6_dscp_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wds_data_prioritization_info_ind_v01, ul_ipv6_dscp)
};

/*
 * wds_get_data_prioritization_info_req_msg is empty
 * static const uint8_t wds_get_data_prioritization_info_req_msg_data_v01[] = {
 * };
 */

static const uint8_t wds_get_data_prioritization_info_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wds_get_data_prioritization_info_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wds_get_data_prioritization_info_resp_msg_v01, mux_id) - QMI_IDL_OFFSET8(wds_get_data_prioritization_info_resp_msg_v01, mux_id_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wds_get_data_prioritization_info_resp_msg_v01, mux_id),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wds_get_data_prioritization_info_resp_msg_v01, ul_data_prio_state) - QMI_IDL_OFFSET8(wds_get_data_prioritization_info_resp_msg_v01, ul_data_prio_state_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wds_get_data_prioritization_info_resp_msg_v01, ul_data_prio_state),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wds_get_data_prioritization_info_resp_msg_v01, ul_ipv4_dscp) - QMI_IDL_OFFSET8(wds_get_data_prioritization_info_resp_msg_v01, ul_ipv4_dscp_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wds_get_data_prioritization_info_resp_msg_v01, ul_ipv4_dscp),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wds_get_data_prioritization_info_resp_msg_v01, ul_ipv6_dscp) - QMI_IDL_OFFSET8(wds_get_data_prioritization_info_resp_msg_v01, ul_ipv6_dscp_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wds_get_data_prioritization_info_resp_msg_v01, ul_ipv6_dscp)
};
...
static const qmi_idl_message_table_entry wds_message_table_v01[] = {
  ...
  {sizeof(wds_data_prioritization_info_ind_v01), wds_data_prioritization_info_ind_data_v01},
  {sizeof(wds_get_data_prioritization_info_req_msg_v01), 0},
  {sizeof(wds_get_data_prioritization_info_resp_msg_v01), wds_get_data_prioritization_info_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry wds_service_command_messages_v01[] = {
  ...
  {QMI_WDS_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 7), 446},
  ...
  {QMI_WDS_GET_DATA_PRIORITIZATION_INFO_REQ_V01, QMI_IDL_TYPE16(0, 394), 0},
...
static const qmi_idl_service_message_table_entry wds_service_response_messages_v01[] = {
  ...
  {QMI_WDS_GET_DATA_PRIORITIZATION_INFO_RESP_V01, QMI_IDL_TYPE16(0, 395), 23},
...
static const qmi_idl_service_message_table_entry wds_service_indication_messages_v01[] = {
  ...
  {QMI_WDS_DATA_PRIORITIZATION_INFO_IND_V01, QMI_IDL_TYPE16(0, 393), 16},
