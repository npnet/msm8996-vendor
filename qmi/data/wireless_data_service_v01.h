...
#define WDS_V01_IDL_MINOR_VERS 0xB4
...
typedef struct {
  ...
  */
  ...
  uint8_t report_data_prioritization_info_valid;  /**< Must be set to true if report_data_prioritization_info is being passed */
  uint8_t report_data_prioritization_info;
  /**<    Report Data Prioritization Information.
        Values: \n
       - 0 -- Do not report \n
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Indication Message; Indicates the data prioritization information. */
typedef struct {
  ...
  uint8_t mux_id_valid;  /**< Must be set to true if mux_id is being passed */
  uint8_t mux_id;
  /**<   MUX ID on which the data prioritization information is applicable
  */

  /* Optional */
  /*  Uplink Prioritization State */
  uint8_t ul_data_prio_state_valid;  /**< Must be set to true if ul_data_prio_state is being passed */
  uint8_t ul_data_prio_state;
  /**<   if uplink data prioritization is enabled or disabled
  */

  /* Optional */
  /*  UL IPV4 DSCP */
  uint8_t ul_ipv4_dscp_valid;  /**< Must be set to true if ul_ipv4_dscp is being passed */
  uint8_t ul_ipv4_dscp;
  /**<   DSCP value for IPv4 packets to be prioritized on uplink
    */

  /* Optional */
  /*  UL IPV6 DSCP */
  uint8_t ul_ipv6_dscp_valid;  /**< Must be set to true if ul_ipv6_dscp is being passed */
  uint8_t ul_ipv6_dscp;
  /**<   DSCP value for IPv6 packets to be prioritized on uplink
     */
}wds_data_prioritization_info_ind_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Retrieve information of the packet data connection */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}wds_get_data_prioritization_info_req_msg_v01;
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Retrieve information of the packet data connection */
typedef struct {
  ...
  */
  ...
  uint8_t ul_data_prio_state;
  /**<   Values: \n
       - 0 -- uplink data prioritization is disabled \n
       - 1 -- uplink data prioritization is enabled
  */
  ...
  /**<   DSCP value for IPv6 packets to be prioritized on uplink
       */
}wds_get_data_prioritization_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_WDS_DATA_PRIORITIZATION_INFO_IND_V01
...
//#define REMOVE_QMI_WDS_GET_DATA_PRIORITIZATION_INFO_V01
...
#define QMI_WDS_DATA_PRIORITIZATION_INFO_IND_V01 0x0104
#define QMI_WDS_GET_DATA_PRIORITIZATION_INFO_REQ_V01 0x0105
#define QMI_WDS_GET_DATA_PRIORITIZATION_INFO_RESP_V01 0x0105
