...
/* File path where Single LED calibration data is saved to or loaded from.
 * OEMs should redefine this */
#define SINGLE_LED_CALIB_FILE_PATH "/data/misc/camera/single_led_calibration"
...
typedef struct _awb_biz_t
{
  ...
  q3a_led_calib_mode_t led_calib_mode;
  boolean led_calib_done;
