/* isp_module.c
 *
 * Copyright (c) 2012-2014,2017, 2019 Qualcomm Technologies, Inc. All Rights Reserved.
  ...
  unsigned int session_id)
{
  ...
  if (session_param->offline_num_isp) {
    ISP_ERR("warning: ISP offline resource is not freed on time!");
    ret = isp_resource_deallocate(module, &isp->isp_resource, session_id,
