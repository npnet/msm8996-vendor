/* scaler44_util.c
 *
 * Copyright (c) 2012-2013, 2019 Qualcomm Technologies, Inc. All Rights Reserved.
  ...
  mct_stream_info_t *stream_info)
{
  ...
  scaler->hw_stream_info.width_before_dis = hw_stream_info->width;
  scaler->hw_stream_info.height_before_dis = hw_stream_info->height;
  ...
  ISP_HIGH("width %d height %d fmt %d", hw_stream_info->width,
    hw_stream_info->height, hw_stream_info->fmt);
  PTHREAD_MUTEX_UNLOCK(&scaler->mutex);
  return TRUE;
