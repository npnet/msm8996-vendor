...
int module_wnr_configure_client(wnr_client_t *p_client)
{
...
#if defined (CHROMATIX_309) || defined (CHROMATIX_310)
  ...
  defined (CHROMATIX_308) || defined (CHROMATIX_309) || defined (CHROMATIX_310)
