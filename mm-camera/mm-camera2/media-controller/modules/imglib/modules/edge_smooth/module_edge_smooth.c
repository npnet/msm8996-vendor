  ...
  void* p_basemod)
{
  ...
  p_pproc_caps->width_padding =
    mct_util_calculate_lcm(p_pproc_caps->width_padding, 128);
  p_pproc_caps->height_padding =
    mct_util_calculate_lcm(p_pproc_caps->height_padding, 128);
  p_common_caps->plane_padding =
    mct_util_calculate_lcm(p_common_caps->plane_padding, 128);
  return TRUE;
}
