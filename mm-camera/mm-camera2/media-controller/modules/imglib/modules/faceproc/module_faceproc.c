  ...
  mct_event_t *event)
{
  ...
  case MCT_EVENT_MODULE_EVENT: {
    ...
    case MCT_EVENT_MODULE_STATS_AF_UPDATE: {
      stats_update_t *stats_update =
        (stats_update_t *)(event->u.module_event.module_event_data);
     IDBG_MED("%s:%d] MCT_EVENT_MODULE_STATS_AF_UPDATE af_status %d",
       __func__, __LINE__,
    ...
    case MCT_EVENT_MODULE_IFACE_REQUEST_META_STREAM_INFO: {
      ...
      pp_meta_stream_info_request_t *p_mstream_req =
        (pp_meta_stream_info_request_t *)(event->u.module_event.module_event_data);
      IDBG_MED("%s:%d] MCT_EVENT_MODULE_IFACE_REQUEST_META_STREAM_INFO num %d",
        __func__, __LINE__,
  ...
  unsigned int sessionid)
{
  ...
  *p_analysis_info = p_cap->analysis_info[CAM_ANALYSIS_INFO_FD_STILL];
  ...
  IDBG_INFO("Caps ROI %d scene_mode_cnt %d HW analysis supported %d",
    p_cap->max_num_roi,
    p_cap->supported_scene_modes_cnt,
