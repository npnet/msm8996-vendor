  ...
  cam_related_system_calibration_data_t *dual_data)
{
  ...
  if (e_items_for_cal->is_dual && e_items->is_dual) {
    ...
    dual_data->ref_mono_gain =
      dc->system_calib_params.ref_mono_gain;
    dual_data->ref_mono_linecount =
      dc->system_calib_params.ref_mono_linecount;
    dual_data->ref_bayer_gain =
      dc->system_calib_params.ref_bayer_gain;
    dual_data->ref_bayer_linecount =
      dc->system_calib_params.ref_bayer_linecount;
    dual_data->ref_bayer_color_temperature =
      dc->system_calib_params.ref_bayer_color_temperature;
  }else {
