...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.7/voice/api/voice_service_v02.h#45 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define VOICE_V02_IDL_MINOR_VERS 0x7A
...
#define QMI_VOICE_CALL_COMP_SUBJECT_MAX_LEN_V02 64
#define QMI_VOICE_CALL_COMP_PIC_URL_MAX_LEN_V02 256
...
#define QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02 7
...
/** @addtogroup voice_qmi_enums
  ...
  */
typedef enum {
  SUPS_DOMAIN_ENUM_MIN_ENUM_VAL_V02 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  SUPS_DOMAIN_AUTOMATIC_V02 = 0x01,
  SUPS_DOMAIN_CS_V02 = 0x02,
  SUPS_DOMAIN_PS_V02 = 0x03,
  SUPS_DOMAIN_ENUM_MAX_ENUM_VAL_V02 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}sups_domain_enum_v02;
/**
    @}
  */
...
/** @addtogroup voice_qmi_enums
  ...
  */
typedef enum {
  CALL_COMPOSER_IMPORTANCE_ENUM_MIN_ENUM_VAL_V02 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CALL_COMP_IMP_NORMAL_V02 = 0x00, /**<  Normal \n  */
  CALL_COMP_IMP_URGENT_V02 = 0x01, /**<  Urgent  */
  CALL_COMPOSER_IMPORTANCE_ENUM_MAX_ENUM_VAL_V02 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}call_composer_importance_enum_v02;
/**
    @}
  */
...
}call_composer_coordinate_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  call_composer_coordinate_type_v02 coordinates;
}call_composer_location_point_type_v02;  /* Type */
/**
    @}
  */
...
}call_composer_location_circle_type_v02;  /* Type */
/**
    @}
  */
 ...
 */
  ...
  */
  ...
  /**<   Indicates the mode on which previous call failed.
       ...
       call failure information. If this TLV is not configured, this message is treated as a
       Legacy Dial Call command.
  */
  ...
  */
  ...
  /* Optional */
  /*  Call Composer Importance  */
  uint8_t call_composer_importance_valid;  /**< Must be set to true if call_composer_importance is being passed */
  call_composer_importance_enum_v02 call_composer_importance;
  /**<   Importance of the call. Values: \n
      - CALL_COMP_IMP_NORMAL (0x00) --  Normal \n
      - CALL_COMP_IMP_URGENT (0x01) --  Urgent  \n
 If this TLV is not configured, the importance is treated as normal.
 */

  /* Optional */
  /*  Call Composer Subject  */
  uint8_t call_composer_subject_valid;  /**< Must be set to true if call_composer_subject is being passed */
  uint32_t call_composer_subject_len;  /**< Must be set to # of elements in call_composer_subject */
  uint16_t call_composer_subject[QMI_VOICE_CALL_COMP_SUBJECT_MAX_LEN_V02];
  /**<   Subject of the call. This text can contain up to 64 UTF-16 characters
       and it is not guaranteed to be NULL terminated. If this TLV is not configured,
       it indicates that there is no subject and the field is empty.
  */

  /* Optional */
  /*  Call Composer Picture URL  */
  uint8_t call_composer_picture_url_valid;  /**< Must be set to true if call_composer_picture_url is being passed */
  char call_composer_picture_url[QMI_VOICE_CALL_COMP_PIC_URL_MAX_LEN_V02 + 1];
  /**<   URL for the uploaded picture. If this TLV is not configured,
       it indicates that there is no picture URL and the field is empty.
  */

  /* Optional */
  /*  Call Composer Point Geo-Location */
  uint8_t call_composer_point_location_valid;  /**< Must be set to true if call_composer_point_location is being passed */
  call_composer_location_point_type_v02 call_composer_point_location;
  /**<   User-provided point geo-location. If this TLV is not configured, it indicates
       that there is no point geo-location.
  */

  /* Optional */
  /*  Call Composer Circle Geo-Location */
  uint8_t call_composer_circle_location_valid;  /**< Must be set to true if call_composer_circle_location is being passed */
  call_composer_location_circle_type_v02 call_composer_circle_location;
  /**<   User-provided circle geo-location. If this TLV is not configured, it indicates
       that there is no circle geo-location.
  */

  /* Optional */
  /*  Do not transmit MSD at Call Connect */
  uint8_t do_not_transmit_msd_call_connect_valid;  /**< Must be set to true if do_not_transmit_msd_call_connect is being passed */
  uint8_t do_not_transmit_msd_call_connect;
  /**<   Indicates whether to transmit MSD on Call Connect; boolean value.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Call state. Values: \n
       ...
       - 0x0B -- CALL_STATE_PRE_ALERTING   -- MT call is in Pre Alerting state (applicable to IMS Call Composer)
  */
...
typedef struct {
  ...
  uint8_t local_call_composer_is_supported;
  /**<   Local call composer capability. Indicates whether call composer is supported.
  */

  uint8_t peer_call_composer_is_supported;
  /**<   Peer call composer capability. Indicates whether call composer is supported.
  */
}voice_call_composer_capabilities_type_v02;  /* Type */
/**
    @}
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Local and Peer Call Composer Capabilities Information */
  uint8_t call_composer_capabilities_valid;  /**< Must be set to true if call_composer_capabilities is being passed */
  voice_call_composer_capabilities_type_v02 call_composer_capabilities;
...
typedef struct {
  ...
  */
  ...
  voice_call_composer_capabilities_type_v02 call_composer_capabilities;
  /**<   Local and peer call composer capability.
   */
}voice_call_composer_capabilities_info_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  call_composer_importance_enum_v02 importance;
  /**<   Importance of the call. Values: \n
      - CALL_COMP_IMP_NORMAL (0x00) --  Normal \n
      - CALL_COMP_IMP_URGENT (0x01) --  Urgent
 */
}voice_call_composer_importance_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  uint32_t subject_len;  /**< Must be set to # of elements in subject */
  uint16_t subject[QMI_VOICE_CALL_COMP_SUBJECT_MAX_LEN_V02];
  /**<   Subject of the call. This text can contain up to 64 UTF-16
       characters and it is not guaranteed to be NULL terminated.
  */
}voice_call_composer_subject_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  char picture_url[QMI_VOICE_CALL_COMP_PIC_URL_MAX_LEN_V02 + 1];
  /**<   URL for the uploaded picture.
  */
}voice_call_composer_pic_url_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  call_composer_location_point_type_v02 point_location;
  /**<   Point geo-location.
  */
}voice_call_composer_location_point_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Circle geo-location.
  */
}voice_call_composer_location_circle_type_v02;  /* Type */
/**
    @}
  */
...
data. */
  ...
  */
  ...
  /* Optional */
  /*  Local and Peer Call Composer Capabilities Information */
  uint8_t call_composer_capabilities_info_valid;  /**< Must be set to true if call_composer_capabilities_info is being passed */
  uint32_t call_composer_capabilities_info_len;  /**< Must be set to # of elements in call_composer_capabilities_info */
  voice_call_composer_capabilities_info_type_v02 call_composer_capabilities_info[QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02];

  /* Optional */
  /*  Call Composer Importance */
  uint8_t call_composer_importance_valid;  /**< Must be set to true if call_composer_importance is being passed */
  uint32_t call_composer_importance_len;  /**< Must be set to # of elements in call_composer_importance */
  voice_call_composer_importance_type_v02 call_composer_importance[QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02];

  /* Optional */
  /*  Call Composer Subject  */
  uint8_t call_composer_subject_valid;  /**< Must be set to true if call_composer_subject is being passed */
  uint32_t call_composer_subject_len;  /**< Must be set to # of elements in call_composer_subject */
  voice_call_composer_subject_type_v02 call_composer_subject[QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02];

  /* Optional */
  /*  Call Composer Picture URL  */
  uint8_t call_composer_picture_url_valid;  /**< Must be set to true if call_composer_picture_url is being passed */
  uint32_t call_composer_picture_url_len;  /**< Must be set to # of elements in call_composer_picture_url */
  voice_call_composer_pic_url_type_v02 call_composer_picture_url[QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02];

  /* Optional */
  /*  Call Composer Point Geo-Location */
  uint8_t call_composer_point_location_valid;  /**< Must be set to true if call_composer_point_location is being passed */
  uint32_t call_composer_point_location_len;  /**< Must be set to # of elements in call_composer_point_location */
  voice_call_composer_location_point_type_v02 call_composer_point_location[QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02];

  /* Optional */
  /*  Call Composer Circle Geo-Location */
  uint8_t call_composer_circle_location_valid;  /**< Must be set to true if call_composer_circle_location is being passed */
  uint32_t call_composer_circle_location_len;  /**< Must be set to # of elements in call_composer_circle_location */
  voice_call_composer_location_circle_type_v02 call_composer_circle_location[QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02];
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  USSD domain pref */
  uint8_t ussd_domain_pref_valid;  /**< Must be set to true if ussd_domain_pref is being passed */
  sups_domain_enum_v02 ussd_domain_pref;
  /**<   Domain pref over which the ussd is to be originated. values: \n
       - 0x01-- SUPS_DOMAIN_AUTOMATIC \n
       - 0x02-- SUPS_DOMAIN_CS
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  USSD domain route */
  uint8_t ussd_domain_route_valid;  /**< Must be set to true if ussd_domain_route is being passed */
  sups_domain_enum_v02 ussd_domain_route;
  /**<   Domain route which the ussd is sent values: \n
       - 0x02-- SUPS_DOMAIN_CS \n
       - 0x03-- SUPS_DOMAIN_PS
  */
...
typedef struct {
  ...
  /**<   Domain route which the ussd is sent values: \n
       ...
       - 0x03-- SUPS_DOMAIN_PS
  */
}voice_ussd_release_ind_msg_v02;  /* Message */
/**
    @}
  */
...
typedef enum {
  ...
  VOICE_ECALL_MSD_START_RECEIVED_V02 = 0x05, /**<  Start received and SYNC is locked  */
  ...
  VOICE_ECALL_MSD_TRANSMISSION_OUTBAND_STARTED_V02 = 0x0A, /**<  Outband MSD transmission started  */
  VOICE_ECALL_MSD_TRANSMISSION_OUTBAND_SUCCESS_V02 = 0x0B, /**<  Outband MSD Transmission Success  */
  VOICE_ECALL_MSD_TRANSMISSION_OUTBAND_FAILURE_V02 = 0x0C, /**<  Outband MSD Transmission Failure  */
...
typedef struct {
  ...
  */
  ...
  /**<   Minimum set of data transmission status. Values: \n
      ...
      - VOICE_ECALL_MSD_START_RECEIVED (0x05) --  Start received and SYNC is locked
      ...
      - VOICE_ECALL_MSD_TRANSMISSION_OUTBAND_STARTED (0x0A) --  Outband MSD transmission started
      - VOICE_ECALL_MSD_TRANSMISSION_OUTBAND_SUCCESS (0x0B) --  Outband MSD Transmission Success
      - VOICE_ECALL_MSD_TRANSMISSION_OUTBAND_FAILURE (0x0C) --  Outband MSD Transmission Failure
 */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Informs clients about the eCall HLAP Timer Status. */
typedef struct {

  /* Optional */
  /*  eCall t2 Timer Status */
  ...
  /**<   eCall HLAP t2 timer status. Values: \n
 ...
 */
  ...
  /**<   eCall HLAP t5 timer status. Values: \n
      - VOICE_ECALL_TIMER_STATUS_INACTIVE (0x00) --  eCall timer status inactive \n
      - VOICE_ECALL_TIMER_STATUS_ACTIVE (0x01) --  eCall timer Status active \n
      - VOICE_ECALL_TIMER_STATUS_STARTED (0x02) --  eCall timer status started \n
      - VOICE_ECALL_TIMER_STATUS_STOPPED (0x03) --  eCall timer Status stopped \n
 ...
 */
  ...
  /**<   eCall HLAP t6 timer status. Values: \n
      - VOICE_ECALL_TIMER_STATUS_INACTIVE (0x00) --  eCall timer status inactive \n
      - VOICE_ECALL_TIMER_STATUS_ACTIVE (0x01) --  eCall timer Status active \n
      - VOICE_ECALL_TIMER_STATUS_STARTED (0x02) --  eCall timer status started \n
      - VOICE_ECALL_TIMER_STATUS_STOPPED (0x03) --  eCall timer Status stopped \n
 ...
 */
  ...
  /**<   eCall HLAP t7 timer status. Values: \n
      - VOICE_ECALL_TIMER_STATUS_INACTIVE (0x00) --  eCall timer status inactive \n
      - VOICE_ECALL_TIMER_STATUS_ACTIVE (0x01) --  eCall timer Status active \n
      - VOICE_ECALL_TIMER_STATUS_STARTED (0x02) --  eCall timer status started \n
      - VOICE_ECALL_TIMER_STATUS_STOPPED (0x03) --  eCall timer Status stopped \n
 ...
 */
  ...
  /**<   eCall HLAP t9 timer status. Values: \n
      - VOICE_ECALL_TIMER_STATUS_INACTIVE (0x00) --  eCall timer status inactive \n
      - VOICE_ECALL_TIMER_STATUS_ACTIVE (0x01) --  eCall timer Status active \n
      - VOICE_ECALL_TIMER_STATUS_STARTED (0x02) --  eCall timer status started \n
      - VOICE_ECALL_TIMER_STATUS_STOPPED (0x03) --  eCall timer Status stopped \n
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Gets the eCall HLAP timer status. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Gets the eCall HLAP timer status. */
typedef struct {
...
typedef struct {
  ...
  /* Mandatory */
  /*  eCall Era GLONASS Is Enabled  */
  uint8_t is_era_glonass_enabled;
  /**<   Check if eCall era GLONASS is enabled. Values: \n
        - 0x00 -- FALSE \n
        - 0x01 -- TRUE
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Gets the eCall era GLONASS enabled status. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Gets the eCall era GLONASS enabled status. */
typedef struct {
...
typedef struct {
  ...
  */
  ...
  mt_ims_verstat_enum_v02 mt_call_verstat_info;
  /**<   Verstat information for the rejected call. \n
      - MT_IMS_TN_VALIDATION_NONE (0) --  No telephone number validation obtained from the network \n
      - MT_IMS_TN_VALIDATION_PASS (1) --  Telephone number validation from the network PASSED \n
      - MT_IMS_TN_VALIDATION_FAIL (2) --  Telephone number validation from the network FAILED \n
 */
 ...
 */
  ...
  uint16_t call_composer_subject[QMI_VOICE_CALL_COMP_SUBJECT_MAX_LEN_V02];
  /**<   Subject of the call. \n
       This text can contain up to 64 UTF-16 characters and it is not guaranteed
