                                            ...
                                            sce_buf_type_t buf_type)
{
    ...
    if(buf_type == buf_tuple.sce_buf1.buf_type) {
        ...
        CHECK_COND_MSG(true, SCE_ERROR_INVALID_PARAMS, "Invalid buff types");
    }
                                 ...
                                 uint32_t &out_buf_size)
{
    ...
    /*------------------------------------------------------------------------
      For Copy API request sent to TA, first buffer of request must be DS and
      second buffer must be a Non Secure buffer.
      ------------------------------------------------------------------------*/
