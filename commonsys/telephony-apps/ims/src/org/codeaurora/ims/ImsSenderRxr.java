...
public class ImsSenderRxr extends ImsPhoneBaseCommands {
    ...
    class ImsRadioResponse extends vendor.qti.hardware.radio.ims.V1_6.IImsRadioResponse.Stub {
         ...
         */
        @Override
        public void sendUssdResponse(int token, int errorCode, SipErrorInfo errorDetails) {
        }
    ...
    class ImsRadioIndication extends vendor.qti.hardware.radio.ims.V1_6.IImsRadioIndication.Stub {
        ...
        public void onIncomingCallAutoRejected_1_6(
                vendor.qti.hardware.radio.ims.V1_6.AutoCallRejectionInfo autoCallRejectionInfo) {
            //stub
        }
        ...
        */
        ...
        public void onRetrievingGeoLocationDataStatus(int geoLocationDataStatus) {
            //Dummy API resolve compilation error
        }
    }
