...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/4.7/voice/src/voice_service_v02.c#45 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Tue Mar 31 2020 (Spin 0)
...
static const uint8_t call_composer_coordinate_type_data_v02[] = {
  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(call_composer_coordinate_type_v02, latitude),

  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(call_composer_coordinate_type_v02, longitude),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t call_composer_location_point_type_data_v02[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(call_composer_location_point_type_v02, coordinates),
  QMI_IDL_TYPE88(0, 99),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t call_composer_location_circle_type_data_v02[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(call_composer_location_circle_type_v02, coordinates),
  QMI_IDL_TYPE88(0, 99),
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(call_composer_location_circle_type_v02, radius),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_call_composer_capabilities_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_call_composer_capabilities_type_v02, local_call_composer_is_supported),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_call_composer_capabilities_type_v02, peer_call_composer_is_supported),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_call_composer_capabilities_info_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_call_composer_capabilities_info_type_v02, call_id),

  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_call_composer_capabilities_info_type_v02, call_composer_capabilities),
  QMI_IDL_TYPE88(0, 102),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_call_composer_importance_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_call_composer_importance_type_v02, call_id),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_call_composer_importance_type_v02, importance),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_call_composer_subject_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_call_composer_subject_type_v02, call_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(voice_call_composer_subject_type_v02, subject),
  QMI_VOICE_CALL_COMP_SUBJECT_MAX_LEN_V02,
  QMI_IDL_OFFSET8(voice_call_composer_subject_type_v02, subject) - QMI_IDL_OFFSET8(voice_call_composer_subject_type_v02, subject_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_call_composer_pic_url_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_call_composer_pic_url_type_v02, call_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET8(voice_call_composer_pic_url_type_v02, picture_url),
  ((QMI_VOICE_CALL_COMP_PIC_URL_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_CALL_COMP_PIC_URL_MAX_LEN_V02) >> 8),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_call_composer_location_point_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_call_composer_location_point_type_v02, call_id),

  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_call_composer_location_point_type_v02, point_location),
  QMI_IDL_TYPE88(0, 100),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_call_composer_location_circle_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_call_composer_location_circle_type_v02, call_id),

  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_call_composer_location_circle_type_v02, call_composer_circle_location),
...
static const uint8_t voice_dial_call_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_failure_reason) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_failure_reason_valid)),
  0x2A,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, call_failure_reason),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_composer_importance) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_composer_importance_valid)),
  0x2B,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, call_composer_importance),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_composer_subject) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_composer_subject_valid)),
  0x2C,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, call_composer_subject),
  QMI_VOICE_CALL_COMP_SUBJECT_MAX_LEN_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_composer_subject) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_composer_subject_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_composer_picture_url) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_composer_picture_url_valid)),
  0x2D,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, call_composer_picture_url),
  ((QMI_VOICE_CALL_COMP_PIC_URL_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_CALL_COMP_PIC_URL_MAX_LEN_V02) >> 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_composer_point_location) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_composer_point_location_valid)),
  0x2E,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, call_composer_point_location),
  QMI_IDL_TYPE88(0, 100),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_composer_circle_location) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, call_composer_circle_location_valid)),
  0x2F,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, call_composer_circle_location),
  QMI_IDL_TYPE88(0, 101),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, do_not_transmit_msd_call_connect) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, do_not_transmit_msd_call_connect_valid)),
  0x30,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, do_not_transmit_msd_call_connect)
};
...
static const uint8_t voice_get_call_info_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, alternate_sip_uri) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, alternate_sip_uri_valid)),
  0x29,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_info_resp_msg_v02, alternate_sip_uri),
  QMI_VOICE_SIP_URI_MAX_V02,

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_capabilities) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_capabilities_valid)),
  0x2A,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_info_resp_msg_v02, call_composer_capabilities),
  QMI_IDL_TYPE88(0, 102),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_importance) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_importance_valid)),
  0x2B,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_info_resp_msg_v02, call_composer_importance),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_subject) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_subject_valid)),
  0x2C,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_info_resp_msg_v02, call_composer_subject),
  QMI_VOICE_CALL_COMP_SUBJECT_MAX_LEN_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_subject) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_subject_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_picture_url) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_picture_url_valid)),
  0x2D,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_info_resp_msg_v02, call_composer_picture_url),
  ((QMI_VOICE_CALL_COMP_PIC_URL_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_CALL_COMP_PIC_URL_MAX_LEN_V02) >> 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_point_location) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_point_location_valid)),
  0x2E,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_info_resp_msg_v02, call_composer_point_location),
  QMI_IDL_TYPE88(0, 100),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_circle_location) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_circle_location_valid)),
  0x2F,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_info_resp_msg_v02, call_composer_circle_location),
  QMI_IDL_TYPE88(0, 101)
};
...
static const uint8_t voice_all_call_status_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, tir_mode) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, tir_mode_valid)),
  0x41,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_capabilities_info) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_capabilities_info_valid)),
  0x42,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, call_composer_capabilities_info),
  QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_capabilities_info) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_capabilities_info_len),
  QMI_IDL_TYPE88(0, 103),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_importance) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_importance_valid)),
  0x43,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, call_composer_importance),
  QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_importance) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_importance_len),
  QMI_IDL_TYPE88(0, 104),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_subject) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_subject_valid)),
  0x44,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, call_composer_subject),
  QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_subject) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_subject_len),
  QMI_IDL_TYPE88(0, 105),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_picture_url) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_picture_url_valid)),
  0x45,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, call_composer_picture_url),
  QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_picture_url) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_picture_url_len),
  QMI_IDL_TYPE88(0, 106),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_point_location) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_point_location_valid)),
  0x46,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, call_composer_point_location),
  QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_point_location) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_point_location_len),
  QMI_IDL_TYPE88(0, 107),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_circle_location) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_circle_location_valid)),
  0x47,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, call_composer_circle_location),
  QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_circle_location) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_circle_location_len),
...
static const uint8_t voice_get_all_call_info_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, alternate_sip_uris) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, alternate_sip_uris_valid)),
  0x30,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_capabilities_info) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_capabilities_info_valid)),
  0x31,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_all_call_info_resp_msg_v02, call_composer_capabilities_info),
  QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_capabilities_info) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_capabilities_info_len),
  QMI_IDL_TYPE88(0, 103),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_importance) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_importance_valid)),
  0x32,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_all_call_info_resp_msg_v02, call_composer_importance),
  QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_importance) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_importance_len),
  QMI_IDL_TYPE88(0, 104),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_subject) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_subject_valid)),
  0x33,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_all_call_info_resp_msg_v02, call_composer_subject),
  QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_subject) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_subject_len),
  QMI_IDL_TYPE88(0, 105),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_picture_url) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_picture_url_valid)),
  0x34,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_all_call_info_resp_msg_v02, call_composer_picture_url),
  QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_picture_url) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_picture_url_len),
  QMI_IDL_TYPE88(0, 106),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_point_location) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_point_location_valid)),
  0x35,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_all_call_info_resp_msg_v02, call_composer_point_location),
  QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_point_location) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_point_location_len),
  QMI_IDL_TYPE88(0, 107),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_circle_location) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_circle_location_valid)),
  0x36,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_all_call_info_resp_msg_v02, call_composer_circle_location),
  QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_circle_location) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_circle_location_len),
  QMI_IDL_TYPE88(0, 108)
};
...
static const uint8_t voice_orig_ussd_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_req_msg_v02, is_secondary) - QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_req_msg_v02, is_secondary_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_orig_ussd_req_msg_v02, is_secondary),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_req_msg_v02, ussd_domain_pref) - QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_req_msg_v02, ussd_domain_pref_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_orig_ussd_req_msg_v02, ussd_domain_pref)
};
...
static const uint8_t voice_orig_ussd_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_resp_msg_v02, ussd_error_description) - QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_resp_msg_v02, ussd_error_description_valid)),
  0x1B,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_resp_msg_v02, ussd_domain_route) - QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_resp_msg_v02, ussd_domain_route_valid)),
  0x1C,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_orig_ussd_resp_msg_v02, ussd_domain_route)
};
...
static const uint8_t voice_ussd_release_ind_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_ussd_release_ind_msg_v02, ussd_domain_route) - QMI_IDL_OFFSET8(voice_ussd_release_ind_msg_v02, ussd_domain_route_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_ussd_release_ind_msg_v02, ussd_domain_route)
};
...
static const uint8_t voice_ussd_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_ussd_ind_msg_v02, ussd_error_description) - QMI_IDL_OFFSET16RELATIVE(voice_ussd_ind_msg_v02, ussd_error_description_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_FLAGS_UTF16_STRING,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_ussd_ind_msg_v02, ussd_domain_route) - QMI_IDL_OFFSET16RELATIVE(voice_ussd_ind_msg_v02, ussd_domain_route_valid)),
  0x15,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_ussd_ind_msg_v02, ussd_domain_route)
};
...
static const uint8_t voice_sups_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_sups_ind_msg_v02, barred_numbers_list) - QMI_IDL_OFFSET16RELATIVE(voice_sups_ind_msg_v02, barred_numbers_list_valid)),
  0x23,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_sups_ind_msg_v02, ussd_domain_route) - QMI_IDL_OFFSET16RELATIVE(voice_sups_ind_msg_v02, ussd_domain_route_valid)),
  0x24,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_sups_ind_msg_v02, ussd_domain_route)
};
...
static const uint8_t voice_orig_ussd_no_wait_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_orig_ussd_no_wait_req_msg_v02, ussd_domain_pref) - QMI_IDL_OFFSET8(voice_orig_ussd_no_wait_req_msg_v02, ussd_domain_pref_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_orig_ussd_no_wait_req_msg_v02, ussd_domain_pref)
};
...
static const uint8_t voice_orig_ussd_no_wait_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_orig_ussd_no_wait_resp_msg_v02, ussd_domain_route) - QMI_IDL_OFFSET8(voice_orig_ussd_no_wait_resp_msg_v02, ussd_domain_route_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_orig_ussd_no_wait_resp_msg_v02, ussd_domain_route)
};
...
static const uint8_t voice_orig_ussd_no_wait_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_no_wait_ind_msg_v02, sip_error_code) - QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_no_wait_ind_msg_v02, sip_error_code_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_orig_ussd_no_wait_ind_msg_v02, sip_error_code),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_no_wait_ind_msg_v02, ussd_domain_route) - QMI_IDL_OFFSET16RELATIVE(voice_orig_ussd_no_wait_ind_msg_v02, ussd_domain_route_valid)),
  0x17,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_orig_ussd_no_wait_ind_msg_v02, ussd_domain_route)
};
...
static const uint8_t voice_modified_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, is_secure_call) - QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, is_secure_call_valid)),
  0x1B,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, is_secure_call),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, call_composer_capabilities) - QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, call_composer_capabilities_valid)),
  0x1C,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, call_composer_capabilities),
  QMI_IDL_TYPE88(0, 102)
};
...
static const uint8_t auto_rejected_incoming_call_end_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, mt_call_verstat_info) - QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, mt_call_verstat_info_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, mt_call_verstat_info),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_importance) - QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_importance_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_importance),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_subject) - QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_subject_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_subject),
  QMI_VOICE_CALL_COMP_SUBJECT_MAX_LEN_V02,
  QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_subject) - QMI_IDL_OFFSET8(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_subject_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_picture_url) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_picture_url_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_picture_url),
  ((QMI_VOICE_CALL_COMP_PIC_URL_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_CALL_COMP_PIC_URL_MAX_LEN_V02) >> 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_point_location) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_point_location_valid)),
  0x15,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_point_location),
  QMI_IDL_TYPE88(0, 100),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_circle_location) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_circle_location_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_circle_location),
  QMI_IDL_TYPE88(0, 101)
};
...
static const qmi_idl_type_table_entry  voice_type_table_v02[] = {
  ...
  {sizeof(call_composer_coordinate_type_v02), call_composer_coordinate_type_data_v02},
  {sizeof(call_composer_location_point_type_v02), call_composer_location_point_type_data_v02},
  {sizeof(call_composer_location_circle_type_v02), call_composer_location_circle_type_data_v02},
  {sizeof(voice_call_composer_capabilities_type_v02), voice_call_composer_capabilities_type_data_v02},
  {sizeof(voice_call_composer_capabilities_info_type_v02), voice_call_composer_capabilities_info_type_data_v02},
  {sizeof(voice_call_composer_importance_type_v02), voice_call_composer_importance_type_data_v02},
  {sizeof(voice_call_composer_subject_type_v02), voice_call_composer_subject_type_data_v02},
  {sizeof(voice_call_composer_pic_url_type_v02), voice_call_composer_pic_url_type_data_v02},
  {sizeof(voice_call_composer_location_point_type_v02), voice_call_composer_location_point_type_data_v02},
  {sizeof(voice_call_composer_location_circle_type_v02), voice_call_composer_location_circle_type_data_v02}
};
...
static const qmi_idl_message_table_entry voice_message_table_v02[] = {
  ...
  {sizeof(voice_ussd_release_ind_msg_v02), voice_ussd_release_ind_msg_data_v02},
...
static const qmi_idl_service_message_table_entry voice_service_command_messages_v02[] = {
  ...
  {QMI_VOICE_DIAL_CALL_REQ_V02, QMI_IDL_TYPE16(0, 2), 2975},
  ...
  {QMI_VOICE_ORIG_USSD_REQ_V02, QMI_IDL_TYPE16(0, 44), 282},
  ...
  {QMI_VOICE_ORIG_USSD_NO_WAIT_REQ_V02, QMI_IDL_TYPE16(0, 58), 194},
...
static const qmi_idl_service_message_table_entry voice_service_response_messages_v02[] = {
  ...
  {QMI_VOICE_GET_CALL_INFO_RESP_V02, QMI_IDL_TYPE16(0, 9), 3406},
  ...
  {QMI_VOICE_GET_ALL_CALL_INFO_RESP_V02, QMI_IDL_TYPE16(0, 26), 24778},
  ...
  {QMI_VOICE_ORIG_USSD_RESP_V02, QMI_IDL_TYPE16(0, 45), 1751},
  ...
  {QMI_VOICE_ORIG_USSD_NO_WAIT_RESP_V02, QMI_IDL_TYPE16(0, 59), 14},
...
static const qmi_idl_service_message_table_entry voice_service_indication_messages_v02[] = {
  ...
  {QMI_VOICE_ALL_CALL_STATUS_IND_V02, QMI_IDL_TYPE16(0, 24), 32748},
  {QMI_VOICE_SUPS_NOTIFICATION_IND_V02, QMI_IDL_TYPE16(0, 29), 1144},
  {QMI_VOICE_USSD_RELEASE_IND_V02, QMI_IDL_TYPE16(0, 50), 7},
  {QMI_VOICE_USSD_IND_V02, QMI_IDL_TYPE16(0, 51), 1455},
  {QMI_VOICE_UUS_IND_V02, QMI_IDL_TYPE16(0, 52), 135},
  {QMI_VOICE_SUPS_IND_V02, QMI_IDL_TYPE16(0, 57), 6126},
  {QMI_VOICE_ORIG_USSD_NO_WAIT_IND_V02, QMI_IDL_TYPE16(0, 60), 1281},
  {QMI_VOICE_AOC_LOW_FUNDS_IND_V02, QMI_IDL_TYPE16(0, 73), 0},
  {QMI_VOICE_MODIFIED_IND_V02, QMI_IDL_TYPE16(0, 86), 134},
  ...
  {QMI_AUTO_REJECTED_INCOMING_CALL_END_IND_V02, QMI_IDL_TYPE16(0, 132), 546},
