...
void convertToSensor(
        ...
        sensor_t *dst) {
    dst->name = strdup1(src.name.c_str());
    dst->vendor = strdup1(src.vendor.c_str());
    dst->version = src.version;
    ...
    dst->fifoReservedEventCount = src.fifoReservedEventCount;
    dst->fifoMaxEventCount = src.fifoMaxEventCount;
    dst->stringType = strdup1(src.typeAsString.c_str());
    dst->requiredPermission = strdup1(src.requiredPermission.c_str());
    dst->maxDelay = src.maxDelay;
    dst->flags = src.flags;
