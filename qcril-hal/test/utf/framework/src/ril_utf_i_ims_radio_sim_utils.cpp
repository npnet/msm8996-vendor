...
ims_CallType convertHidlToProtoCallType(const V1_6::CallType& callType) {
    switch (callType) {
        case V1_6::CallType::CALL_TYPE_USSD:
            return ims_CallType_CALL_TYPE_USSD;
        case V1_6::CallType::CALL_TYPE_CALLCOMPOSER:
            return ims_CallType_CALL_TYPE_CALLCOMPOSER;
        default:
            return V1_0::utils::convertHidlToProtoCallType((V1_0::CallType) callType);
    }
}
...
ims_Error convertHidlToProtoCallDetails(const V1_6::CallDetails& inCallDetails,
    ims_CallDetails& outCallDetails) {
    if (inCallDetails.callType == V1_6::CallType::CALL_TYPE_INVALID ||
    ...
    ims_Error ret = ims_Error_E_SUCCESS;
    outCallDetails.callType = V1_6::utils::convertHidlToProtoCallType(inCallDetails.callType);
    outCallDetails.has_callType = true;
...
ims_Error convertHidlToProtoServiceStatusInfo(const V1_6::ServiceStatusInfo& inServiceInfo,
    ...
    do {
        ...
        if (inServiceInfo.callType != V1_6::CallType::CALL_TYPE_INVALID) {
            outServiceInfo.has_callType = true;
            outServiceInfo.callType = V1_6::utils::convertHidlToProtoCallType(inServiceInfo.callType);
        }
