...
class IImsRadioResponseClient : public V1_6::IImsRadioResponse {
 public:
  ...
  ::android::hardware::Return<void> setConfigResponse_1_6(
      int32_t token, int32_t errorCode,
...
class IImsRadioIndicationClient : public V1_6::IImsRadioIndication {
 public:
  ...
  ::android::hardware::Return<void> onUssdReceived(
      ::vendor::qti::hardware::radio::ims::V1_5::UssdModeType type,
  ...
  ::android::hardware::Return<void> onIncomingCallComposerCallAutoRejected(
      const ::vendor::qti::hardware::radio::ims::V1_6::AutoCallRejectionInfo &autoCallRejectionInfo,
  ...
  ::android::hardware::Return<void> onCallComposerInfoAvailable(
      const ::vendor::qti::hardware::radio::ims::V1_6::CallComposerInfo &callComposerInfo) {
  ...
  ::android::hardware::Return<void> onIncomingCallAutoRejected_1_6(
      const ::vendor::qti::hardware::radio::ims::V1_6::AutoCallRejectionInfo &autoCallRejectionInfo) {
    RIL_UTF_DEBUG("\n QMI_RIL_UTF: onIncomingCallAutoRejected_1_6");
    ...
    switch (msgId) {
      ...
      case ims_MsgId_REQUEST_SET_SERVICE_STATUS: {
        ...
        if (i_req->has_volteEnabled) {
          ...
          ssInfo.callType = V1_6::CallType::CALL_TYPE_VOICE;
        ...
        if (i_req->has_videoTelephonyEnabled) {
          V1_6::ServiceStatusInfo ssInfo = {};
          ssInfo.callType = V1_6::CallType::CALL_TYPE_VT;
          ssInfo.accTechStatus.resize(1);
          ssInfo.accTechStatus[0].networkMode = V1_6::RadioTechType::RADIO_TECH_LTE;
        ...
        if (i_req->has_utEnabled) {
          V1_6::ServiceStatusInfo ssInfo = {};
          ssInfo.callType = V1_6::CallType::CALL_TYPE_UT;
          ssInfo.accTechStatus.resize(1);
          ssInfo.accTechStatus[0].networkMode = V1_6::RadioTechType::RADIO_TECH_LTE;
