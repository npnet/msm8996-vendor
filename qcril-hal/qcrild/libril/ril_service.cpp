  ...
  do {
    ...
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        [this, serial](std::shared_ptr<Message> msg, Message::Callback::Status status,
          ...
          QCRIL_LOG_DEBUG("getCurrentCallsResponse : calls = %s", toString(calls).c_str());
...
#endif
  auto msg =
      std::make_shared<RilRequestSendSmsMessage>(getContext(serial), message.smscPdu, message.pdu);
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
          ...
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, sendSmsResponse, responseInfo, result);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
  } else {
...
#endif
  auto msg = std::make_shared<RilRequestSendSmsMessage>(getContext(serial), message.smscPdu,
                                                        message.pdu, true);
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
          ...
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, sendSMSExpectMoreResponse, responseInfo,
                                   result);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
...
Return<void> RadioImpl::acknowledgeLastIncomingGsmSms(int32_t serial, bool success,
                                                      SmsAcknowledgeFailCause cause) {
#if VDBG
  RLOGD("acknowledgeLastIncomingGsmSms: serial %d", serial);
#endif
  auto msg = std::make_shared<RilRequestAckGsmSmsMessage>(getContext(serial), success,
  ...
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
          ...
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, acknowledgeLastIncomingGsmSmsResponse,
                                   respInfo);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
...
static void convertRilNetworkResultToHidl(const std::vector<qcril::interfaces::NetworkInfo>& rilData,
...
Return<void> RadioImpl::writeSmsToSim(int32_t serial, const SmsWriteArgs &smsWriteArgs) {
  ...
  auto msg = std::make_shared<RilRequestWriteSmsToSimMessage>(
      getContext(serial), smsWriteArgs.smsc, smsWriteArgs.pdu,
  ...
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
          ...
          if (status == Message::Callback::Status::SUCCESS && resp != nullptr) {
            errorCode = resp->errorCode;
            auto writeSmsResponse = std::static_pointer_cast<RilWriteSmsToSimResult_t>(resp->data);
            if (writeSmsResponse) {
              recordNumber = writeSmsResponse->recordNumber;
            }
          }
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, writeSmsToSimResponse, respInfo,
                                   recordNumber);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
    ...
    RadioResponseInfo respInfo{RadioResponseType::SOLICITED, serial, RadioError::NO_MEMORY};
    RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, writeSmsToSimResponse, respInfo, -1);
  }
...
#endif
  auto msg = std::make_shared<RilRequestDeleteSmsOnSimMessage>(getContext(serial), index);
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
                        Message::Callback::Status status,
          ...
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, deleteSmsOnSimResponse, respInfo);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
  } else {
  ...
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
          ...
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, sendCdmaSmsResponse, responseInfo,
                                   result);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
...
Return<void> RadioImpl::acknowledgeLastIncomingCdmaSms(int32_t serial, const CdmaSmsAck &smsAck) {
  ...
  auto msg = std::make_shared<RilRequestAckCdmaSmsMessage>(
      getContext(serial), smsAck.errorClass == CdmaSmsErrorClass::NO_ERROR, smsAck.smsCauseCode);
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
                        Message::Callback::Status status,
          ...
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, acknowledgeLastIncomingCdmaSmsResponse,
                                   respInfo);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
...
#endif
  auto msg = std::make_shared<RilRequestGetGsmBroadcastConfigMessage>(getContext(serial));
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
                        Message::Callback::Status status,
          ...
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, getGsmBroadcastConfigResponse, respInfo,
                                   configs);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
...
Return<void>
RadioImpl::setGsmBroadcastConfig(int32_t serial,
  ...
  auto msg = std::make_shared<RilRequestGsmSetBroadcastSmsConfigMessage>(getContext(serial),
                                                                         std::move(configVec));
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
          ...
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, setGsmBroadcastConfigResponse,
                                   respInfo);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
    ...
    RadioResponseInfo respInfo{RadioResponseType::SOLICITED, serial, RadioError::NO_MEMORY};
    RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, setGsmBroadcastConfigResponse, respInfo);
  }
...
#endif
  auto msg =
      std::make_shared<RilRequestGsmSmsBroadcastActivateMessage>(getContext(serial), activate);
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
                        Message::Callback::Status status,
          ...
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, setGsmBroadcastActivationResponse,
                                   respInfo);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
    ...
    RadioResponseInfo respInfo{RadioResponseType::SOLICITED, serial, RadioError::NO_MEMORY};
    RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, setGsmBroadcastActivationResponse, respInfo);
  }
...
#endif
  auto msg = std::make_shared<RilRequestGetCdmaBroadcastConfigMessage>(getContext(serial));
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
                        Message::Callback::Status status,
          ...
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, getCdmaBroadcastConfigResponse,
                                   respInfo, configs);
    ...
    hidl_vec<CdmaBroadcastSmsConfigInfo> configs;
    RadioResponseInfo respInfo{RadioResponseType::SOLICITED, serial, RadioError::NO_MEMORY};
    RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, getCdmaBroadcastConfigResponse, respInfo,
                             configs);
  }
...
Return<void>
RadioImpl::setCdmaBroadcastConfig(int32_t serial,
  ...
  auto msg = std::make_shared<RilRequestCdmaSetBroadcastSmsConfigMessage>(getContext(serial),
                                                                          std::move(configVec));
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
          ...
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, setCdmaBroadcastConfigResponse,
                                   respInfo);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
    ...
    RadioResponseInfo respInfo{RadioResponseType::SOLICITED, serial, RadioError::NO_MEMORY};
    RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, setCdmaBroadcastConfigResponse, respInfo);
  }
...
#endif
  auto msg =
      std::make_shared<RilRequestCdmaSmsBroadcastActivateMessage>(getContext(serial), activate);
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
                        Message::Callback::Status status,
          ...
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, setCdmaBroadcastActivationResponse,
                                   respInfo);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
    ...
    RadioResponseInfo respInfo{RadioResponseType::SOLICITED, serial, RadioError::NO_MEMORY};
    RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, setCdmaBroadcastActivationResponse, respInfo);
  }
...
Return<void> RadioImpl::writeSmsToRuim(int32_t serial, const CdmaSmsWriteArgs &cdmaSms) {
  ...
  auto msg = std::make_shared<RilRequestCdmaWriteSmsToRuimMessage>(
      getContext(serial), rcsm, static_cast<int>(cdmaSms.status));
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
                        Message::Callback::Status status,
          ...
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, writeSmsToRuimResponse, respInfo,
                                   recordNumber);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
    ...
    RadioResponseInfo respInfo{RadioResponseType::SOLICITED, serial, RadioError::NO_MEMORY};
    RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, writeSmsToRuimResponse, respInfo, -1);
  }
...
#endif
  auto msg = std::make_shared<RilRequestCdmaDeleteSmsOnRuimMessage>(getContext(serial), index);
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
                        Message::Callback::Status status,
          ...
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, deleteSmsOnRuimResponse, respInfo);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
  } else {
...
#endif
  auto msg = std::make_shared<RilRequestGetSmscAddressMessage>(getContext(serial));
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
                        Message::Callback::Status status,
          ...
          if (status == Message::Callback::Status::SUCCESS && resp != nullptr) {
            errorCode = resp->errorCode;
            auto smscAddrResult = std::static_pointer_cast<RilGetSmscAddrResult_t>(resp->data);
            if (smscAddrResult) {
          ...
          RadioResponseInfo respInfo = {};
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          QCRIL_LOG_ERROR("getSmscAddressResponse : smsc = %s", smsc.c_str());
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, getSmscAddressResponse, respInfo, smsc);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
  } else {
    RadioResponseInfo respInfo{RadioResponseType::SOLICITED, serial, RadioError::NO_MEMORY};
    RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, getSmscAddressResponse, respInfo,
                             hidl_string());
  }
...
#endif
  auto msg = std::make_shared<RilRequestSetSmscAddressMessage>(getContext(serial), smsc);
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
                        Message::Callback::Status status,
          ...
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, setSmscAddressResponse, respInfo);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
  } else {
...
#endif
  auto msg =
      std::make_shared<RilRequestReportSmsMemoryStatusMessage>(getContext(serial), available);
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
                        Message::Callback::Status status,
          ...
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, reportSmsMemoryStatusResponse,
                                   respInfo);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
    ...
    RadioResponseInfo respInfo{RadioResponseType::SOLICITED, serial, RadioError::NO_MEMORY};
    RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, reportSmsMemoryStatusResponse, respInfo);
  }
  ...
  if (msg) {
    GenericCallback<QcRilRequestMessageCallbackPayload> cb(
        ([this, serial]([[maybe_unused]] std::shared_ptr<Message> msg,
          ...
          RadioResponseInfo respInfo = {};
          RIL_Errno errorCode = RIL_E_GENERIC_FAILURE;
          RadioTechnologyFamily radioTechFamily = RadioTechnologyFamily::THREE_GPP;
          if (status == Message::Callback::Status::SUCCESS && resp != nullptr) {
            errorCode = resp->errorCode;
            auto regStateResp = std::static_pointer_cast<RilGetImsRegistrationResult_t>(resp->data);
            if (regStateResp) {
              isRegistered = regStateResp->isRegistered;
              radioTechFamily = regStateResp->ratFamily == RADIO_TECH_3GPP
                                    ? RadioTechnologyFamily::THREE_GPP
                                    : RadioTechnologyFamily::THREE_GPP2;
            }
          }
          populateResponseInfo(respInfo, serial, RESPONSE_SOLICITED, errorCode);
          RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, getImsRegistrationStateResponse,
                                   respInfo, isRegistered, radioTechFamily);
        }));
    msg->setCallback(&cb);
    msg->dispatch();
  } else {
    RadioResponseInfo respInfo{RadioResponseType::SOLICITED, serial, RadioError::NO_MEMORY};
    RADIO_HIDL_SEND_RESPONSE(mSlotId, mRadioResponse, getImsRegistrationStateResponse, respInfo,
                             false, RadioTechnologyFamily::THREE_GPP);
  }
...
Return<void> RadioImpl::sendImsSms(int32_t serial, const ImsSmsMessage& message) {
    ...
    do {
        ...
        auto msg = std::make_shared<RilRequestImsSendSmsMessage>(getContext(serial),
            message.messageRef, tech, message.retry);
        if (msg == nullptr) {
            sendResponse = true;
