...
qcril::interfaces::CallType convertCallType(const V1_6::CallType &in) {
  switch (in) {
  case V1_6::CallType::CALL_TYPE_USSD:
    return qcril::interfaces::CallType::USSD;
  case V1_6::CallType::CALL_TYPE_CALLCOMPOSER:
    return qcril::interfaces::CallType::CALLCOMPOSER;
  default:
    return V1_0::utils::convertCallType((V1_0::CallType) in);
  }
}

V1_6::CallType convertCallType(const qcril::interfaces::CallType &in) {
  switch (in) {
  case qcril::interfaces::CallType::USSD:
    return V1_6::CallType::CALL_TYPE_USSD;
  case qcril::interfaces::CallType::CALLCOMPOSER:
    return V1_6::CallType::CALL_TYPE_CALLCOMPOSER;
  default:
    return (V1_6::CallType) V1_0::utils::convertCallType(in);
  }
}
...
bool convertServiceStatusInfo(V1_6::ServiceStatusInfo &out,
  ...
  if (in.hasCallType()) {
    out.callType = V1_6::utils::convertCallType(in.getCallType());
  } else {
    out.callType = V1_6::CallType::CALL_TYPE_INVALID;
  }
...
void readServiceStatusInfo(const V1_6::ServiceStatusInfo &in,
  ...
  if (in.callType != V1_6::CallType::CALL_TYPE_INVALID) {
    out.setCallType(V1_6::utils::convertCallType(in.callType));
  }
