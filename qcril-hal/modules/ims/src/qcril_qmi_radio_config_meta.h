...
typedef enum
{
    QCRIL_QMI_IMS_CONFIG_INVALID = -1,
...
} qcril_qmi_ims_config_item_type;
...
} qcril_qmi_ims_config_item_value_type;
...
}qcril_qmi_ims_config_settings_resp_type;
...
}qcril_qmi_ims_config_error_type;
...
typedef struct
{
  qcril_qmi_ims_config_item_type config_item;
  void *config_item_value;
  size_t config_item_value_len;
  qcril_qmi_ims_config_item_value_type config_item_value_type;
  void *extra_data;
 ...
 */
typedef qcril_qmi_ims_config_error_type qcril_qmi_radio_config_handler_type
(
...
qcril_qmi_ims_config_item_value_type qcril_qmi_radio_config_get_item_value_type
(
   qcril_qmi_ims_config_item_type config_item
);
 ...
 */
qcril_qmi_ims_config_settings_resp_type qcril_qmi_radio_config_map_qmi_settings_resp_to_radio_config_settings_resp
(
 ...
 */
qcril_qmi_ims_config_error_type qcril_qmi_radio_config_map_qmi_error_to_radio_config_error
(
 ...
 * Radio config error type
 */
qcril_qmi_ims_config_error_type qcril_qmi_radio_config_map_internal_error_to_radio_config_error
(
