...
class ImsModule : public Module, public AddPendingMessageList {
...
#endif
    void setImssHandlers(
        std::function<void (unsigned int, unsigned char *, uint32_t)> h1,
        std::function<void (std::shared_ptr<QcRilRequestImsRegistrationChangeMessage>)> h2,
        std::function<void (std::shared_ptr<QcRilRequestImsSetServiceStatusMessage>)> h3,
        std::function<void (std::shared_ptr<QcRilRequestImsSetConfigMessage>)> h4,
        std::function<void (std::shared_ptr<QcRilRequestImsGetConfigMessage>)> h5) {
      mImssIndicationHandler = h1;
      mSetImsRegistrationChangeHandler = h2;
      mImsSetServiceStatusHandler = h3;
      mImsSetConfigHandler = h4;
      mImsGetConfigHandler = h5;
    }
  ...
  private:
    ...
    std::function<void(unsigned int, unsigned char*, uint32_t)> mImssIndicationHandler;
    std::function<void(std::shared_ptr<QcRilRequestImsGetConfigMessage>)> mImsGetConfigHandler;
    std::function<void(std::shared_ptr<QcRilRequestImsSetConfigMessage>)> mImsSetConfigHandler;
    std::function<void(std::shared_ptr<QcRilRequestImsSetServiceStatusMessage>)>
        mImsSetServiceStatusHandler;
    std::function<void(std::shared_ptr<QcRilRequestImsRegistrationChangeMessage>)>
        mSetImsRegistrationChangeHandler;
