...
class ImsRadioImpl_1_6 : public ImsRadioImplBase,
 ...
 public:
  ...
  ::android::hardware::Return<void> sendUssd(
      int32_t token, const ::android::hardware::hidl_string &ussd);
  ::android::hardware::Return<void> cancelPendingUssd(int32_t token);
  ::android::hardware::Return<void> callComposerDial(int32_t token,
  ...
  ::android::hardware::Return<void> emergencyDial_1_6( int32_t token,
      const ::vendor::qti::hardware::radio::ims::V1_6::DialRequest &dialRequest,
  ...
  ::android::hardware::Return<void> dial_1_6(int32_t token,
           const ::vendor::qti::hardware::radio::ims::V1_6::DialRequest &dialRequest);
