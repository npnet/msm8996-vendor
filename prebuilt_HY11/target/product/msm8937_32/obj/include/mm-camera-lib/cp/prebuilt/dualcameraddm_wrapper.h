...
CP_DLL_PUBLIC void dualcameraddm_k5DFT9dbFc( const uint8_t*, const uint8_t*, int,
                                             ...
                                             const float, bool, int, int&, const char*& );
...
public:
   enum ErrorCode
   {
      ...
      BAD_SEGMENTATION = 4,         // The scene is not segementable
      BACKGROUND_SEGMENTATION = 5   // User selected background for segmentation. Ask user to select a foreground object
   };
...
DDMWrapperStatus dualCameraGenerateDDM( const uint8_t* primaryY,
                                        ...
                                        DepthMapMode ddmMode = DepthMapMode::NORMAL_MODE)
{
   ...
   dualcameraddm_k5DFT9dbFc( primaryY, primaryVU, primaryWidth, primaryHeight, primaryStrideY, primaryStrideVU,
                             ...
                             focalLengthPrimaryCamera, isAuxiliaryMonoSensor, static_cast<int>( ddmMode ), errCode, errMessage );
...
public:
   ...
   DualCameraDDMEffects( const uint8_t* primaryRGBA,
                         ...
                         : _dstImageWidth( dstImageWidth ), _dstImageHeight( dstImageHeight ),
                         _pImpl( NULL )
   {
      typedef DDMWrapperStatus::ErrorCode ErrorCode;
   ...
   ///             This image is brightened version of primary image,
   ///             based on the brightnessIntensity supplied in the constructor.
                                  ...
                                  int dstStride )
   {
      ...
      {
         return DDMWrapperStatus( DDMWrapperStatus::ErrorCode::INVALID_ARGUMENT, "Input intensity outside supported range" );
      }
